...
namespace ARWNI2S.Collections.Generic
{
    ...
    internal class BigList<T> : ListBase<T>, ICloneable
    {
        ...
        private void CheckEnumerationStamp(int startStamp)
        {
            ...
            {
                throw new InvalidOperationException(Resources.Collections_ChangeDuringEnumeration);
            }
        }
        ...
        public sealed override void Insert(int index, T item)
        {
            ...
            if ((uint)Count + 1 > MAXITEMS)
                throw new InvalidOperationException(Resources.Collections_CollectionTooLarge);
        ...
        public BigList<T> CloneContents()
        {
            ...
            else
            {
                ...
                if (!CollectionUtils.IsCloneableType(typeof(T), out itemIsValueType))
                    throw new InvalidOperationException(string.Format(Resources.Collections_TypeNotCloneable, typeof(T).FullName));
        ...
        {
            if (copies < 0)
                throw new ArgumentOutOfRangeException("copies", Resources.Collections_ArgMustNotBeNegative);
        ...
        private sealed class ConcatNode : Node
        {
            ...
            public override void Print(string prefixNode, string prefixChildren)
            {
                Console.WriteLine("{0}CONCAT {1} {2} count={3} depth={4}", prefixNode, shared ? "S" : " ", IsBalanced() ? "B" : IsAlmostBalanced() ? "A" : " ", _count, _depth);
