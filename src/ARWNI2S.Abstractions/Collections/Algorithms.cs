    ...
    internal static class Algorithms
    {
        ...
        private class ListRange<T> : ListBase<T>, ICollection<T>
        {
            ...
            public override bool Remove(T item)
            {
                if (_wrappedList.IsReadOnly)
                    throw new NotSupportedException(string.Format(Resources.Collections_CannotModifyCollection, "Range"));
                else
        ...
        private class ArrayRange<T> : ListBase<T>
        {
            ...
            public override void Clear()
            {
                ...
                Algorithms.FillRange(_wrappedArray, _wrappedArray.Length - _count, _count, default(T));
                _count = 0;
            }
        ...
        private class ReadOnlyCollection<T> : ICollection<T>
        {
            ...
            {
                throw new NotSupportedException(string.Format(Resources.Collections_CannotModifyCollection, "read-only collection"));
            }
        ...
        private class ReadOnlyList<T> : IList<T>
        {
            ...
            private static void MethodModifiesCollection()
            {
                throw new NotSupportedException(string.Format(Resources.Collections_CannotModifyCollection, "read-only list"));
            }
        ...
        private class ReadOnlyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
        {
            ...
            private static void MethodModifiesCollection()
            {
                throw new NotSupportedException(string.Format(Resources.Collections_CannotModifyCollection, "read-only dictionary"));
            }
        ...
        private class TypedCollection<T> : ICollection<T>
        {
            ...
            private static void MethodModifiesCollection()
            {
                throw new NotSupportedException(string.Format(Resources.Collections_CannotModifyCollection, "strongly-typed Collection"));
            }
        ...
        private class UntypedCollection<T> : ICollection
        {
            ...
            public void CopyTo(Array array, int index)
            {
                ...
                if (index < 0)
                    throw new ArgumentOutOfRangeException("index", index, Resources.Collections_ArgMustNotBeNegative);
                if (index >= array.Length || count > array.Length - index)
                    throw new ArgumentException("index", Resources.Collections_ArrayTooSmall);
        ...
        private class UntypedList<T> : IList
        {
            ...
            private static T ConvertToItemType(string name, object value)
            {
                ...
                {
                    throw new ArgumentException(string.Format(Resources.Collections_WrongType, value, typeof(T)), name);
                }
            }
        ...
        public static void ReplaceInPlace<T>(IList<T> list, T itemFind, T replaceWith, IEqualityComparer<T> equalityComparer)
        {
            ...
            if (list.IsReadOnly)
                throw new ArgumentException(Resources.Collections_ListIsReadOnly, "list");
        ...
        public static T Maximum<T>(IEnumerable<T> collection, IComparer<T> comparer)
        {
            ...
            if (!foundOne)
                throw new InvalidOperationException(Resources.Collections_CollectionIsEmpty);
            else
                return maxSoFar;
        }
        ...
        private class CollectionEqualityComparer<T> : IEqualityComparer<IEnumerable<T>>
        {
            ...
            {
                return Algorithms.EqualCollections(x, y, _equalityComparer);
            }
        ...
        public static ICollection<T> RemoveWhere<T>(ICollection<T> collection, Predicate<T> predicate)
        {
            ...
            if (collection.IsReadOnly)
                throw new ArgumentException(Resources.Collections_ListIsReadOnly, "collection");
        ...
        {
            if (n < 0)
                throw new ArgumentOutOfRangeException("n", n, Resources.Collections_ArgMustNotBeNegative);
            ...
            using (IEnumerator<T> sourceEnum = source.GetEnumerator())
            {
                ...
                while (sourceEnum.MoveNext())
                {
                    if (destIndex >= dest.Length)
                        throw new ArgumentException(Resources.Collections_ArrayTooSmall, "dest");
        ...
        public static void Copy<T>(IEnumerable<T> source, IList<T> dest, int destIndex, int count)
        {
            ...
            if (dest == null)
                throw new ArgumentNullException("dest");
            if (dest.IsReadOnly)
                throw new ArgumentException(Resources.Collections_ListIsReadOnly, "dest");
