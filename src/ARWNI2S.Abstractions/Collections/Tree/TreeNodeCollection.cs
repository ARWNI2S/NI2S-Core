...
{
    /// <summary>
    /// Implements a collection of Tree Nodes <see cref="TreeNode{T}"/>
    /// <para><b>Implementation Note:</b> The root of a data tree is always a <see cref="TreeNode{T}"/>. You cannot
    /// create a standalone <see cref="TreeNodeCollection{T}"/>.
    /// </para>
    /// </summary>
