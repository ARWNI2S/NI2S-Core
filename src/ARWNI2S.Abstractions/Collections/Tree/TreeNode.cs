...
namespace ARWNI2S.Collections.Tree
{
    ...
    public class TreeNode<T>
    {
        ...
        /// <summary>
        /// Node data
        /// Setting the value fires <see cref="TreeRoot{T}.OnNodeChanged"/>
        /// </summary>
        ...
        /// <summary>
        /// returns all siblings as a <see cref="TreeNodeCollection{T}"/>. If this is a root node, the function returns null.
        /// </summary>
        [XmlIgnore]
        ...
        /// <summary>
        /// returns all child nodes as a <see cref="TreeNodeCollection{T}"/>. 
