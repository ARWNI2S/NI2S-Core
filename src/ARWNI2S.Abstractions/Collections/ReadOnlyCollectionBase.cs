...
namespace ARWNI2S.Collections
{
    ...
    public abstract class ReadOnlyCollectionBase<T> : ICollection<T>, ICollection
    {
        ...
        {
            throw new NotSupportedException(string.Format(Resources.Collections_CannotModifyCollection, CollectionUtils.SimpleClassName(GetType())));
        }
        ...
        public virtual void CopyTo(T[] array, int arrayIndex)
        {
            ...
            if (count < 0)
                throw new IndexOutOfRangeException(Resources.Collections_ArgMustNotBeNegative);
            if (arrayIndex < 0)
                throw new ArgumentOutOfRangeException("arrayIndex", arrayIndex, Resources.Collections_ArgMustNotBeNegative);
            if (arrayIndex >= array.Length || count > array.Length - arrayIndex)
                throw new ArgumentException("arrayIndex", Resources.Collections_ArrayTooSmall);
