...
namespace ARWNI2S.Collections
{
                                                                                                  ...
                                                                                                  IDictionary<TKey, TValue>, IDictionary
    {
        ...
        public virtual TValue this[TKey key]
        {
            ...
            set
            {
                throw new NotImplementedException(Resources.Collections_MustOverrideIndexerSet);
            }
        }
        ...
        private static void CheckGenericType<ExpectedType>(string name, object value)
        {
            if (!(value is ExpectedType))
                throw new ArgumentException(string.Format(Resources.Collections_WrongType, value, typeof(ExpectedType)), name);
        }
        ...
        private class DictionaryEnumeratorWrapper : IDictionaryEnumerator
        {
            ...
            public void Reset()
            {
                throw new NotSupportedException(Resources.Collections_ResetNotSupported);
            }
