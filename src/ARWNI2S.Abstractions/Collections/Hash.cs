...
namespace ARWNI2S.Collections
{
    ...
    internal class Hash<T> : IEnumerable<T>, ISerializable, IDeserializationCallback
    {
        ...
        public float LoadFactor
        {
            ...
            set
            {
                ...
                if (value < 0.25 || value > 0.95)
                    throw new ArgumentOutOfRangeException("value", value, Resources.Collections_InvalidLoadFactor);
        ...
        {
            Console.WriteLine("count={0}  usedSlots={1}  totalSlots={2}", _count, _usedSlots, _totalSlots);
