...
namespace ARWNI2S.Caching
{
    ...
    /// </summary>
    public partial class PerContextCacheManager : CacheKeyService, IShortTermCacheManager
    {
        #region Fields
        ...
        public PerContextCacheManager(NI2SSettings nodeSettings) : base(nodeSettings)
        {
