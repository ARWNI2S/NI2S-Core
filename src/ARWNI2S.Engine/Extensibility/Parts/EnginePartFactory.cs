...
{
    /// <summary>
    /// Specifies a contract for synthesizing one or more <see cref="NI2SPart"/> instances
    ...
    {
        /// <summary>
        /// Gets one or more <see cref="NI2SPart"/> instances for the specified <paramref name="assembly"/>.
        /// </summary>
        /// <param name="assembly">The <see cref="Assembly"/>.</param>
        public abstract IEnumerable<NI2SPart> GetEngineParts(Assembly assembly);
