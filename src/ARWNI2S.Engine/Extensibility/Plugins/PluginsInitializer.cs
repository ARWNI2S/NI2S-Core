...
namespace ARWNI2S.Extensibility.Plugins
{
    ...
    internal static class PluginsInitializer
    {
        ...
        /// <returns>Assembly</returns>
        private static Assembly PerformFileDeploy(this INiisPartManager enginePartManager,
        ...
        /// <param name="enginePartManager">Engine part manager</param>
        /// <param name="pluginConfig">Plugin config</param>
        public static void InitializePlugins(this INiisPartManager enginePartManager, PluginConfig pluginConfig)
        {
